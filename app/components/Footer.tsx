      ...
      <div className="container mx-auto py-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-3 grid grid-cols-2 md:grid-cols-3 gap-8">
            <div>
              <h3 className="text-primary font-medium mb-4">Platform</h3>
            ...
            <div>
              <h3 className="text-primary font-medium mb-4">Yasal</h3>
              <ul className="space-y-2 text-sm">
                <li>
                ...
                <li>
                  <Link href="/copyright" className="text-gray-500 hover:text-primary transition-colors">
                    Telif Hakkı
                  </Link>
                </li>
              </ul>
            ...
            <div>
              <h3 className="text-primary font-medium mb-4">Keşfet</h3>
              <ul className="space-y-2 text-sm">
                <li>
                  <Link href="/popular" className="text-gray-500 hover:text-primary transition-colors">
                    Popüler Başlıklar
                  </Link>
                </li>
                <li>
                  <Link href="/today" className="text-gray-500 hover:text-primary transition-colors">
                    Bugünkü Başlıklar
                  </Link>
                </li>
                <li>
                  <Link href="/debe" className="text-gray-500 hover:text-primary transition-colors">
                    Dünün En Beğenilenleri
                  </Link>
                </li>
                <li>
                  <Link href="/topics/create" className="text-gray-500 hover:text-primary transition-colors">
                    Yeni Başlık Aç
                  </Link>
                </li>
              </ul>
        ...
        <div className="mt-8 pt-6 border-t border-gray-200 text-center text-sm text-gray-500">
          <p>© {currentYear} hubX sözlük - Tüm hakları saklıdır</p>
        </div>
      </div>
    </footer>
  );

      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-6 md:mb-0">
            <Link href="/" className="text-2xl font-bold text-primary">
              hubX <span className="text-gray-700">sözlük</span>
            </Link>
            <p className="text-gray-500 mt-2">
              Modern bir sosyal sözlük platformu
            </p>
          </div>
          
          <div className="flex space-x-6">
            <Link href="/hakkinda" className="text-gray-600 hover:text-primary">
              Hakkında
            </Link>
            <Link href="/kurallar" className="text-gray-600 hover:text-primary">
              Kurallar
            </Link>
        ...
        <div className="mt-8 pt-6 border-t border-gray-100 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-500 text-sm">
            &copy; {currentYear} hubX sözlük. Tüm hakları saklıdır.
          </p>
